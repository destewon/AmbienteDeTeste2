...
public class AlunoView {
	...
	public void iniciaGui() {
		...
		jpwSenha.addFocusListener(new FocusListener() {
		...
		// label Sexo
		lblSexo = new JLabel();
		lblSexo.addFocusListener(new FocusListener() {

			public void focusLost(FocusEvent e) {
				// TODO Auto-generated method stub

				lblSexo.setBorder(txtBairro.getBorder());
			}

			public void focusGained(FocusEvent e) {
				// TODO Auto-generated method stub

				lblSexo.setBorder(new LineBorder(new Color(30, 144, 255)));
			}
		});
		...
		txtLogradouro.addFocusListener(new FocusListener() {
		...
		txtBairro.addFocusListener(new FocusListener() {
			...
			public void focusLost(FocusEvent e) {
				...
				txtBairro.setBorder(txtComplemento.getBorder());
			}
		...
		cboCidade.addFocusListener(new FocusListener() {

			public void focusLost(FocusEvent e) {
				// TODO Auto-generated method stub

				cboCidade.setBorder(cboEstado.getBorder());
			}
		...
		cboEstado.addFocusListener(new FocusListener() {

			public void focusLost(FocusEvent e) {
				// TODO Auto-generated method stub

				cboEstado.setBorder(cboCidade.getBorder());
			}
		...
		btm1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				aluno.inserirAluno(txtNome.getText(), txtMatricula.getText(), txtDataNascimento.getText(),
						txtRg.getText(), txtCpf.getText(), txtTelefone.getText(), opcaoSelecionada().charAt(0), senha,
						txtLogradouro.getText(), txtNumero.getText(), txtCep.getText(), txtComplemento.getText(),
						txtBairro.getText(), cidade, estado);
